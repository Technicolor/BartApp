...
public class StationInfoDB {	
	...
	public void loadStations() {
		Thread newThread = new Thread(new StationDBLoadRunnable());
		newThread.start();
	}
	...
	class StationDBLoadRunnable implements Runnable {
	...
	} //End StationDBLoadRunnable class
